...
FLORA_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (FLORA_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Flora requires {FLORA_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
VulkanSDKDebugLibsURL = 'https://jheflingerdload.web.app/files/VulkanSDK-DebugLibs.zip'
OutputDirectory = "Flora/vendor/VulkanSDK"
